                  ...
                  {recentIncidents.map((incident) => (
                    <div key={incident.id} className="border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer relative" onClick={() => navigate(`/incidents/${incident.id}`)}>
                      <div className="absolute right-4 top-4">
                        <Badge 
                          variant="outline"
                          className={`text-xs font-medium px-3 py-1 rounded-full border transition-all duration-300 hover:scale-105 hover:brightness-110 ${
                      ...
                      <div className="pr-16">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-1 text-sm text-gray-600 mt-2">
                          {incident.datacenter_alias && (
                            <div><strong>Datacenter:</strong> {incident.datacenter_alias}</div>
                          )}
                          {incident.datahall_alias && (
                            <div><strong>Data Hall:</strong> {incident.datahall_alias}</div>
                          )}
                          {incident.tile_location && (
                            <div><strong>Tile:</strong> {incident.tile_location}</div>
                          )}
                          {incident.device_id && (
