            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {recentAudits.map(audit => <div key={audit.id} onClick={() => navigate(`/audit/details/${audit.id}`)} className="flex items-center gap-4 p-3 rounded-lg border hover:border-primary cursor-pointer transition-all hover:shadow-sm">
