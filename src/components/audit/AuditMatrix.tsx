            ...
            <TableHeader>
              <TableRow>
                ...
                {deviceTypes.map(device => (
                  <TableHead key={device} className="w-40 text-center">
                    {device}
                  </TableHead>
                ))}
                              ...
                              <span className="truncate">
                                {selectedAlerts.length === 0 
                                  ...
                                  : selectedAlerts.length === 1 
                                    ? selectedAlerts[0].label
                                    : `${selectedAlerts.length} Issues`
                                }
                              </span>
                            ...
                            <div className="space-y-2">
                              {alertTypes.filter(alert => alert.value !== 'none').map(alert => (
                                <div key={alert.value} className="flex items-center space-x-2">
                                  ...
                                  />
                                  <label 
                                    htmlFor={`${rack.id}-${device}-${alert.value}`}
